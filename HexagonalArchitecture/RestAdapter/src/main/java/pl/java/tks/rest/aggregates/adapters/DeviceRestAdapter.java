...
import pl.java.tks.rest.aggregates.mappers.DeviceMapper;
import pl.java.tks.rest.model.DeviceDtoRest;
import pl.java.tks.service.DeviceService;
import pl.java.tks.user_interfaces.AddDevicePort;
import pl.java.tks.user_interfaces.DeleteDevicePort;
