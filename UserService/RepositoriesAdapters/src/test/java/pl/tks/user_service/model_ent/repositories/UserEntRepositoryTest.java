package pl.tks.user_service.model_ent.repositories;
...
class UserEntRepositoryTest {
    ...
    private final ClientEnt client = new ClientEnt("Adam", "Kowalski", "adam123", "password", 14);
    private final ClientEnt client1 = new ClientEnt("Jan", "Kowalski", "jan123", "password", 18);
    ...
    @Test
    void addUser() {
        ClientEnt addTest = new ClientEnt("Test", "Add", "add123", "password", 99);
    ...
    @Test
    void updateUser() {
        ClientEnt update = new ClientEnt("Update", "Add", "Update123", "password", 11);
