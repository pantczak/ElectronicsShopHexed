...
public class UserConverter {
    ...
    public static UserEnt convertUserToEnt(User user) {
        ...
        if (user instanceof Client) {
            ClientEnt clientEnt = new ClientEnt(user.getName(), user.getLastName(), user.getLogin(), user.getPassword());
    ...
    public static User convertEntToUser(UserEnt user) {
        ...
        if (user instanceof ClientEnt) {
            Client client = new Client(user.getName(), user.getLastName(), user.getLogin(), user.getPassword());
