...
class UserRepositoryTest {
    ...
    private final Client client1 = new Client("Jan", "Kowalski", "jan123", "password");
    ...
    @Test
    void addUser() {
        Client addTest = new Client("Test", "Add", "add123", "password");
    ...
    @Test
    void updateUser() {
        Client update = new Client("Update", "Add", "Update123", "password");
