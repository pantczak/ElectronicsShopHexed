...
class UserServiceImplIT {
    ...
    @Test
    void addClient() {
        Client newClient = new Client("Adam", "Adam", "new", "asd");
    ...
    void testAddClient() {
        Client newClient = new Client("Adam", "Adam", "new", "asd");
        int size = service.getAll().size();
        service.addClient(newClient.getLogin(), newClient.getName(), newClient.getLastName(), newClient.getPassword());
        assertEquals(size + 1, service.getAll().size());
    }
    ...
    @Test
    void updateClient() {
        Client update = new Client("update", "update", "update", "asd");
        User user = service.getAll().get(0);
        service.updateClient(user, update.getLogin(), update.getName(), update.getLastName());
